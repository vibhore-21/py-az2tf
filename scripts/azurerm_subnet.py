        ...
        for i in range(0, count):
            ...
            for j in range(0, jcount):
                ...
                try:
                    ...
                    for k in range(0, kcount):
                        ...
                        try:
                            ...
                            sdact = str(ast.literal_eval(
                                json.dumps(subs[j]["properties"]["delegations"][k]["properties"]["actions"])))
                            sdact = sdact.replace("'", '"')
                ...
                try:
                    ...
                    if snsgrg[0].isdigit(): snsgrg = "rg_" + snsgrg
                    fr.write(
                        '\tnetwork_security_group_id = azurerm_network_security_group.' + snsgrg + '__' + snsgid + '.id' + '\n')
                    fr.write('}' + ' \n')
                except KeyError:
                    pass
